...
export function CollapsibleServices() {
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen} className="flex flex-col gap-6">
      {/* Visible Services */}
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          },
          {
            ...
            img: "/dtp.png",
            desc: "Multilingual DTP services delivering accurate, publication-ready layouts across languages.",
          },
          {
          ...
          <div key={i} className="flex flex-col justify-between gap-2 bg-white rounded-md p-4 w-56">
